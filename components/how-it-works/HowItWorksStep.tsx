...
const HowItWorksStep = ({ step }: { step: Props }) => {
    ...
    return (
        <div className={cn(
            ...
            {/* ---- Image Part ---- */}
            <div className="w-full md:w-[45%] lg:w-[35%] hover:scale-105 active:scale-105 transition-all duration-400 aspect-square relative overflow-hidden rounded-xl bg-white/5 shadow-xl">
                <Image
                    src={image}
                    width={400}
                    height={400}
